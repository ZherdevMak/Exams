...
// return instance.delete(`posts/${id}`) неправильно
//
// import axios from 'axios'
...
// // Пример ответа: const [currentPage, setCurrentPage] = useState(page)
//
// Ответ:return instance.get<PhotoType[]>(`albums/${page}/photos?_limit=2`)
//
// Вопрос:
//
...
// // P.S. Эта ошибка из реальной жизни, студенты часто ошибаются и не могут понять в чем дело.
//
// Ответ:'https://jsonplaceholder.typicode.com/user/${todoId}/todos'
//
//     Вопрос:
//
